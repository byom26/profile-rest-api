...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        return Response({'messahe': 'Hello', 'a_viewset': a_viewset})
...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,) #Here we are using , to make it a tuple & not a single item
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (permissions.UpdteOwnStatus, IsAuthenticated)
